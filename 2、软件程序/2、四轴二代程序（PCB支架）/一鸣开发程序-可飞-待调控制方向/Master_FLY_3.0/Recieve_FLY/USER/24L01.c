...
const u8 TX_ADDRESS[TX_ADR_WIDTH]={0x36,0x63,0x10,0x10,0x01}; //发送地址
const u8 RX_ADDRESS[RX_ADR_WIDTH]={0x36,0x63,0x10,0x10,0x01};
...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB, ENABLE);	 //使能PAB端口时钟
  ...
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;	
	...
	GPIO_ResetBits(GPIOA,GPIO_Pin_3);//PG6,7,8上拉	
