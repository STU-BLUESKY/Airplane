...
void TIM2_IRQHandler(void)   
{
	...
	{	
		Get_Attitude();			
		Cascade_PID_Calc(EulerAngle.Pitch,EulerAngle.Roll,0);
		if(fly_allow) 
		{
			if 			(Throttle == 10) Motor_Move(	100,	0,	0,	0);
			else if (Throttle == 20) Motor_Move(	0,	100,	0,	0);
			else if (Throttle == 30) Motor_Move(	0,	0,	100,	0);
			else if (Throttle == 40) Motor_Move(	0,	0,	0,	100);
			else Motor_Move(	Motor_PWM.M1,	Motor_PWM.M2,	Motor_PWM.M3,	Motor_PWM.M4);
		}	
//		Motor_Move(	Motor_PWM.M1,	Motor_PWM.M2,	Motor_PWM.M3,	Motor_PWM.M4);
